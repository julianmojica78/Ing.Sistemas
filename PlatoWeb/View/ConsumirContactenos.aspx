<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPagePrincipal.master" AutoEventWireup="true" CodeFile="~/Controller/ConsumirContactenos.aspx.cs" Inherits="View_ConsumirContactenos" %>
        ...
        <table class="nav-justified">
            <tr>
                ...
                <td class="auto-style5">
                    <h3>
                        <asp:Label ID="L_title" runat="server" Text="Contactenos"></asp:Label>
                    </h3>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="TB_apellido" runat="server" class="form-control" MaxLength="30" ValidationGroup="uno" ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TB_apellido" ErrorMessage="*" ForeColor="Red" ValidationGroup="uno"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TB_apellido" ErrorMessage="Ingrese solo letras" ForeColor="Red" ValidationExpression="^[A-Za-z_ ]*$" ValidationGroup="uno"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="TB_Email" runat="server" class="form-control" MaxLength="30" TextMode="Email" ValidationGroup="uno"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TB_Email" ErrorMessage="*" ForeColor="Red" ValidationGroup="uno"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style4">&nbsp;</td>
            ...
            <tr>
                <td class="auto-style4">
                    <asp:Label ID="LB_Detalle" runat="server" Text="Detalle:"></asp:Label>
                </td>
                <td class="auto-style5">
                    ...
                    <asp:RegularExpressionValidator ID="revTexbox3" runat="server"
                        ...
                        Display="Dynamic" ForeColor="Red" ValidationGroup="uno"></asp:RegularExpressionValidator>
