    ...
    <table class="nav-justified">
        ...
        <tr>
            <td class="auto-style4" colspan="3">
                <h3>
                    <asp:Label ID="LB_pedidos" runat="server" Text="Pedidos"></asp:Label>
                </h3>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 0.1%" class="auto-style1">
                &nbsp;</td>
            <td class="auto-style1">
                <asp:GridView ID="GV_Despachar" runat="server" AutoGenerateColumns="False" DataSourceID="ODS_Plato" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="100%" DataKeyNames="id_pedido" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                    <Columns>
                        <asp:BoundField DataField="id_pedido" HeaderText="Pedido" />
        ...
        <tr>
            <td class="auto-style5" colspan="3">
                <h3>
                    <asp:Label ID="LB_Reservas" runat="server" Text="Reservas"></asp:Label>
                </h3>
            </td>
        </tr>
        <tr>
