<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="~/Controller/Ofertas.aspx.cs" Inherits="View_Ofertas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <table class="nav-justified" style="width: 102%">
    <tr>
        <td class="text-center" colspan="2" style="font-size: medium"><strong><asp:Label ID="L_insertmenu" runat="server" Text="INSERTAR OFERTA"></asp:Label>
            </strong></td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RegularExpressionValidator ID="REV_desc" runat="server"
    ...
    <tr>
        <td class="text-right">
            <asp:Label ID="LB_precioOferta" runat="server" Text="Precio con Oferta: "></asp:Label>
        </td>
        <td>
            <asp:TextBox ID="TB_precioOferta" runat="server" MaxLength="8" class="form-control"></asp:TextBox>
        ...
        &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Ingrese solo numeros" ForeColor="Red" ValidationExpression="^[0-9_-]*$" ControlToValidate="TB_precio"></asp:RegularExpressionValidator>
    ...
    <tr>
        <td class="text-right" style="height: 19px">
            <asp:Label ID="LB_seleccionar" runat="server" Text="Seleccione la imagen del plato"></asp:Label>
        </td>
