...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="text-center" colspan="2">
            <asp:Label ID="LB_modimeni" runat="server" Text="MODIFICAR MENU"></asp:Label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="text-right" style="height: 61px">
    ...
    <tr>
        <td class="text-right">
            <asp:Label ID="LB_preciopla" runat="server" Text="Precio del plato: "></asp:Label>
        </td>
        <td>
            <asp:TextBox ID="TB_precio" runat="server" MaxLength="8" class="form-control"></asp:TextBox>
        &nbsp;<asp:RegularExpressionValidator ID="validator_precio" runat="server" ControlToValidate="TB_precio" ErrorMessage="*Ingrese solo Numeros" ForeColor="Red" ValidationExpression="^[A-Za-z0-9_-]*$" ValidationGroup="1"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
        <td class="text-right">
