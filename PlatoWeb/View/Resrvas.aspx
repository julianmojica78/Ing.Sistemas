    ...
    <table class="nav-justified">
        <tr>
            ...
            <td class="auto-style1" colspan="6">
                <h1><strong>
                    <asp:Label ID="L_Reservas" runat="server" Text="RESERVAS"></asp:Label>
                    </strong></h1>
            </td>
            <td style="width: 5%">&nbsp;</td>
        </tr>
        <tr>
            ...
            <td class="auto-style5" colspan="3" style="width: 10%">
                <asp:Label ID="L_Fecha" runat="server" Text="Fecha:" CssClass="auto-style7"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td style="width: 10%" class="text-right">
                <asp:Label ID="L_Hora" runat="server" Text="Hora:" CssClass="auto-style7"></asp:Label>
            </td>
            <td colspan="2">
                        ...
                        <ajaxToolkit:ListSearchExtender ID="DDL_Hora_ListSearchExtender" runat="server" BehaviorID="DDL_Hora_ListSearchExtender" PromptText="Seleccione Opcion" TargetControlID="DDL_Hora">
        ...
        <tr>
            ...
            <td style="width: 40%" colspan="3" class="text-right">
                <asp:Label ID="L_Cantidad" runat="server" CssClass="auto-style7" Text="Cantidad de Personas:"></asp:Label>
            </td>
            <td style="width: 30%">
                <div class="row form-group" style="height: 100%; width: 100%; margin-left: 0px;">
                    <div class="auto-style3" style="height: 100%; width: 100%; margin-left: 0px;">
