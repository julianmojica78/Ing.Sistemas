    ...
    <table class="auto-style27">
        ...
        <tr>
            ...
            <td class="auto-style39">
                ...
                <asp:RegularExpressionValidator ID="REV_Apellido" runat="server" ControlToValidate="TB_Apellido" ErrorMessage="Solo Puede Ingresar Letras" ForeColor="Red" ValidationExpression="^[A-Za-z]*$"></asp:RegularExpressionValidator>
            </td>
            <td style="width: 5%">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style32">
                <asp:RangeValidator ID="RV_Rol" runat="server" ControlToValidate="DDL_Rol" ErrorMessage="Seleccione una Opcion" MaximumValue="3" MinimumValue="2" SetFocusOnError="True" ForeColor="Red"></asp:RangeValidator>
                </td>
        ...
        <tr>
            ...
            <td class="text-center" colspan="4" style="height: 26px">
                <asp:Button ID="B_Modificar" runat="server" OnClick="B_Crear_Click" Text="Modificar" class="btn btn-primary" style="height: 36px"/>
            </td>
