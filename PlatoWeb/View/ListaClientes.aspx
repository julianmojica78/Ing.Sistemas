    ...
    <table class="nav-justified">
        <tr>
            <td colspan="3">
                <h3 class="text-center"><strong>
                    <asp:Label ID="LB_listClien" runat="server" Text="Lista de Clientes"></asp:Label>
                    </strong></h3>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:TextBox ID="TB_Filtro" runat="server" OnTextChanged="TB_Filtro_TextChanged" Width="201px" ValidationGroup="Uno" ></asp:TextBox>
                &nbsp;
                <asp:Button ID="BT_Buscar" runat="server" OnClick="BT_Buscar_Click" Text="Buscar" ValidationGroup="Uno" class="btn btn-primary"/>
                <asp:RegularExpressionValidator ID="REV_Username" runat="server" ControlToValidate="TB_Filtro" ErrorMessage="*Ingrese solo letras" ForeColor="Red" ValidationExpression="^[A-Za-zñÑ]*$" ValidationGroup="1"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td style="width: 5%">&nbsp;</td>
            <td rowspan="5">
                <asp:GridView ID="GV_listClien" runat="server" AllowPaging="True" Width="100%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" PageSize="30">
