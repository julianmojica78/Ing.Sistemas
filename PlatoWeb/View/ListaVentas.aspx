    ...
    <table class="nav-justified">
        <tr>
            <td class="text-center" colspan="3" style="font-size: x-large">
                <h3>
                    <asp:Label ID="LB_listventas" runat="server" Text="Lista de Ventas"></asp:Label>
                </h3>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 5%">
                &nbsp;</td>
            <td>
                    <asp:GridView ID="GV_listVentas" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" Height="115px">
