    ...
    <table class="nav-justified">
        <tr>
            ...
            <td class="text-center" style="90%; height: 20px;">
                <h1>
                    <asp:Label ID="lb_listComen" runat="server" Text="Listado de Comentarios"></asp:Label>
                </h1>
            </td>
        ...
        <tr>
            ...
            <td style="90%; height: 20px;">
                ...
                <asp:TextBox ID="TB_Filtrar" runat="server" OnTextChanged="TB_Filtrar_TextChanged" Width="206px"  MaxLength="20"></asp:TextBox>
        ...
        <tr>
            <td style="width: 5%">&nbsp;</td>
            <td style="90%">
                <asp:RequiredFieldValidator ID="RFV_alerta" runat="server" ControlToValidate="TB_Filtrar" ErrorMessage="No ha Ingresado Nada a Buscar" ForeColor="Red" ValidationGroup="Uno"></asp:RequiredFieldValidator>
        ...
        <tr>
            <td style="width: 5%; height: 20px;"></td>
            <td style="90%; height: 20px;">
                <asp:GridView ID="GV_Listar" runat="server" AllowPaging="True" Width="100%" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" DataSourceID="ODS_Comentarios">
                ...
                <asp:ObjectDataSource ID="ODS_Comentarios" runat="server" SelectMethod="listarComentarios" TypeName="Datos.DUser"></asp:ObjectDataSource>
            </td>
            <td style="width: 5%; height: 20px;"></td>
        </tr>
        <tr>
